...
with open("PROJ3-DNSTS1.txt") as f:
    for line in f:
        ...
        table[addr] = ip
print "[TS1]: Table construction complete"
...
while True:
    ...
    if success == "S":
        if not clientConnected:
            ...
            print "[TS1]: Client connection received from: {}".format(add)
